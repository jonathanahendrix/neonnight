...
class BeginningStoryScene3: SKScene {
    let splashVideo = SKVideoNode(fileNamed: "BS3-Low.mp4")
    ...
    override func didMove(to view: SKView) {
        ...
        let nextScene = BeginningStoryScene4(size: scene!.size)
