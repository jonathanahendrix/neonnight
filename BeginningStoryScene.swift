...
class BeginningStoryScene: SKScene {
    let splashVideo = SKVideoNode(fileNamed: "BS1-Low.mp4")
    ...
    override func didMove(to view: SKView) {
       ...
       let nextScene = BeginningStoryScene2(size: scene!.size)
